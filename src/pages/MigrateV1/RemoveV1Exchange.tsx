...
import { JSBI, Token, TokenAmount, WBNB, Fraction, Percent, CurrencyAmount } from 'swap-bsc-sdk'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${chainId && token.equals(WBNB[chainId]) ? 'WBNB' : token.symbol}/BNB V1 liquidity`
        })
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: 'center' }}>
        {`Your Uniswap V1 ${
          chainId && token.equals(WBNB[chainId]) ? 'WBNB' : token.symbol
    ...
    <BodyWrapper style={{ padding: 24 }} id="remove-v1-exchange">
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <div>
            <QuestionHelper text="Remove your OMGSwap V1 liquidity tokens." />
          </div>
        </AutoRow>
