...
import { Currency, currencyEquals, ETHER, Percent, WBNB } from 'swap-bsc-sdk'
                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWBNB || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/${currencyA === ETHER ? WBNB[chainId].address : currencyIdA}/${
                              currencyB === ETHER ? WBNB[chainId].address : currencyIdB
                            }`}
                          >
                            Receive WBNB
                          </StyledInternalLink>
