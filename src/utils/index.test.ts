...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'swap-bsc-sdk'
...
describe('utils', () => {
  describe('#getBscScanLink', () => {
    ...
    it('ropsten', () => {
      expect(getBscScanLink(3, 'abc', 'address')).toEqual('https://ropsten.bscscan.com/address/abc')
    })
    it('enum', () => {
      expect(getBscScanLink(ChainId.RINKEBY, 'abc', 'address')).toEqual('https://rinkeby.bscscan.com/address/abc')
    })
  })
